...
<!--                 <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <input type="submit" class="btn btn-primary btn-block" name="productUnitRegistrationCreation" value="Enregistrer">
                    </div>

                    <div class="col-sm-3">
                        <input type="submit" class="btn btn-primary btn-block" name="productUnitCancel" value="Retour">
                    </div> 
                </div>
