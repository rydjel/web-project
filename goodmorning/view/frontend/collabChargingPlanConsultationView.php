    ...
    <div class="container-fluid">
        ...
        <br>
            <form action="" method="post">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <select id="select" class="form-control" name="yearChargesCollabConsultation">
                    ...
                    <div class="col-xs-1">
                        <input type="submit" class="btn btn-primary btn-block"name="yearChargesCollabConsultationFilter" value="Filter">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <?php
/*                                             $min=$taskFirstMonth[$key];
                                            $max=$taskLastMonth[$key];
                                            if ($min>1) {
                                                for ($i=1; $i <$min; $i++) { 
                                                    ?> <td></td><td></td>
                                                <?php
                                            ...
                                            while ($data=${"taskCharges".$key}->fetch()) { 
                                                if ($data['mois']==$i) {
                                                ?>
                                                <td><input type="text" class="form-control" value=<?php echo $data['NbJoursPlan']?> readonly></td>
                                                <td><input type="text" class="form-control" value=<?php echo $data['NbJoursReal']?> readonly></td>
                                                <?php
                                                }
                                                else {
                                                    for ($j=$i; $j<$data['mois'] ; $j++) {
                                                        ?>
                                                        <td><input type="text" class="form-control" value=<?php echo 0 ?> readonly></td>
                                                        <td><input type="text" class="form-control" value=<?php echo 0 ?> readonly></td>
                                                        <?php
                                                    }
                                                    ?>
                                            ...
                                            if ($i<12) {
                                                for ($j=$i; $j <=12 ; $j++) { 
                                                    ?>
                                                        <td><input type="text" class="form-control" value=<?php echo 0 ?> ></td>
                                                        <td><input type="text" class="form-control" value=<?php echo 0 ?> ></td>
                                                    <?php
                                                }
                                            }
