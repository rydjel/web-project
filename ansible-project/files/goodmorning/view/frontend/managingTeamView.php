...
<?php ob_start(); ?>
    <div class="container">
        ...
        <header class="page-header">
            <h1> Gestion de l'Equipe Managériale CIS </h1>
        </header>
        <br>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="alert alert-warning alert-dismissible" role="alert">
            <strong>Warning!</strong> Êtes-vous sûr(e)s de vouloir supprimer ce collaborateur de l'équipe managériale ?
        </div>
      </div>
      <input type="hidden" id="managerToDelete">
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" onclick="deleteManager('managerToDelete','deleteManagerModal');">Valider</button>
...
<div class="modal" id="creationManagerModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title"><strong>Création d'un nouveau Manager</strong></h3>
      </div>
      <div class="modal-body">
        <div class="row">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" onclick="createManager('collabChoice','creationManagerModal');">Valider</button>
